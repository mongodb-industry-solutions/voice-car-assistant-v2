...
The catalog contains **standard OBD-II codes** (C0xxx, P0xxx, U0xxx) plus **five custom codes** added for dashboard tell-tale demonstration — these are not standard OBD-II and are marked `[custom]` in the catalog:
